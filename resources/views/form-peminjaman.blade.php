            ...
            <div class="w-100 d-flex">
                <div class="card w-100 my-2 shadow-2-strong">
                    <div class="card-header">
                        <h1 class="mt-5 mb-4">Formulir Rental Mobil</h1>
                    </div>
                    ...
                    <div class="card-footer d-flex align-items-center justify-content-center">
                        <form method="POST" action="{{url('/' . $mobil->id . '/pinjam')}}">
                            @csrf
                            <div class="mb-3">
                              @error('tanggal_mulai')
                              <div class="alert">{{ $message }}</div>
                              @enderror
                              <label for="rentalDate" class="form-label">Tanggal Mulai</label>
                              <input type="date" class="form-control" id="rentalDate" name="tanggal_mulai" required>
                            </div>
                            <div class="mb-3">
                              @error('tanggal_selesai')
                              <div class="alert">{{ $message }}</div>
                              @enderror
                              <label for="returnDate" class="form-label">Tanggal Selesai</label>
                              <input type="date" class="form-control" id="returnDate" name="tanggal_selesai" required>
                            </div>
